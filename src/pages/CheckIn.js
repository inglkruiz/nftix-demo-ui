    ...
    <>
      ...
      {!showScanner && scannedAddress && hasTicket && (
        <>
          ...
          <Flex width="100%" justifyContent="center">
            <Button onClick={checkIn} isLoading={checkInTxnPending} size="lg" colorScheme="teal">
              Check In
            </Button>
          </Flex>
        </>
      ...
      {!showScanner && (
        <>
          ...
          {!hasTicket && (
            <Flex width="100%" justifyContent="center">
              <Button onClick={() => setShowScanner(true)} size="lg" colorScheme="teal">
                Scan QR
              </Button>
            </Flex>
          )}
      ...
      {showScanner && (
        <>
          <Box margin="16px auto 8px auto" padding=" 0 16px" width="360px">
            <QrReader
              ...
              onScan={(data) => {
                ...
                const address = data.text.split('ethereum:')[1].split('@')[0];
          ...
          <Flex width="100%" justifyContent="center">
            <Button onClick={() => setShowScanner(false)} size="lg" colorScheme="red">
              Cancel
            </Button>
          </Flex>
        </>
